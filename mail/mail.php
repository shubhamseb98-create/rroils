...
defined('BASE_URL') || define('BASE_URL', defined('SITE_URL') ? SITE_URL : "https://rroils.com/");

$secret   = "6LczRIAtAAAAAPSGYaZ_oG7NyrGBdHXdlEzx94H2";
...
if ($result && $result->success) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!empty($email) && !empty($name)) {
            ...
            // $to      = SITE_EMAIL;
            $subject = 'RR OILs Query From ' . $name;
...
<body style="margin:0;padding:0;font-family:Arial,sans-serif;background-color:#f8f9fa;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
        ...
        <tr>
                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td style="padding:20px;">
                            <img src="https://rroils.com/uploads/logo.png"
                                alt="Logo"
            ...
            if (!empty($type)) {
                $body .= '<p style="margin:0 0 10px 0;">
                            <strong>Enquiry Type:</strong> ' . nl2br(htmlspecialchars($type)) . '
                          </p>';
            }

            if (!empty($category)) {
                $body .= '<p style="margin:0 0 10px 0;">
                            <strong>Category Of Interest:</strong> ' . nl2br(htmlspecialchars($category)) . '
                          </p>';
            }

            if (!empty($cb_name)) {
                $body .= '<p style="margin:0 0 10px 0;">
                            <strong>Company / Brand Name:</strong> ' . nl2br(htmlspecialchars($cb_name)) . '
                          </p>';
            }

            if (!empty($quantity)) {
                $body .= '<p style="margin:0 0 10px 0;">
                            <strong>Quantity:</strong> ' . nl2br(htmlspecialchars($quantity)) . '
                          </p>';
            }
            ...
            $body .= '
                    ...
                    <tr>
                        <td style="background:rgb(240,107,30);text-align:center;padding:15px 0;">
                            <a href="https://rroils.com/" target="_blank"
            ...
            // Send mail
            $headers  = "From: RR OIL MILL <support@rroils.com>\r\n";
            ...
            echo '<script>window.location="' . BASE_URL . 'mail/thankyou.php";</script>';
            exit;
