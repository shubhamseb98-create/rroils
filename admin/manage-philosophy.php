...
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_philosophy`");
...
$content = mysqli_real_escape_string($conn,$_POST['content']);
	...
	$query = mysqli_query($conn, "UPDATE `tbl_philosophy` SET `subheading`='$subheading',`heading1`='$heading1',`heading2`='$heading2',`heading3`='$heading3',`content`='$content'");
	if ($query == true) {
		$_SESSION['success'] = "Updated Successfully";
		header("refresh:3;url=manage-philosophy.php");
	} else {
...
<body>
	...
	<div id="content" class="content">
		...
		<ol class="breadcrumb pull-right">
			<li class="breadcrumb-item"><a href="javascript:;">Philosophy Management</a></li>
			<li class="breadcrumb-item active">Edit Philosophy</li>
		</ol>
		<!-- end breadcrumb -->
		<!-- begin page-header -->
		<h1 class="page-header"><a href="javascript:;" onClick="javascript:history.go(-1)" class="btn btn-l btn-icon btn-circle btn-primary" data-click="panel-remove"><i class="fa fa-arrow-left"></i></a> Manage Philosophy</h1>
		<!-- begin row -->
		<div class="row">
			<!-- begin col-10 -->
			<div class="col-lg-12">
				...
				<div class="panel panel-inverse">
					...
					<div class="panel-heading">
						...
						<h4 class="panel-title"> Edit Philosophy</h4>
					</div>
					<!-- begin panel-body -->
					<div class="panel-body">
						<form role="form" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="form-group">
									<label for="banner">Enter Heading 3</label>
									<input type="text" name="heading3" class="form-control" value="<?= $brec['heading3']; ?>">
								</div>
