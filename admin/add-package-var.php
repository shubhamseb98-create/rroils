...
//=============|image|============//
	...
	$query=mysqli_query($conn,"INSERT INTO `tbl_package_var`(`packname`,`pack_weight`,`sort`, `status`) VALUES ('$heading1','$heading2','$position','$status')");
    if($query==true)
    {
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				<li class="breadcrumb-item"><a href="javascript:;"> Manage Package Variant</a></li>
				<li class="breadcrumb-item active">Add Package Variant</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Add Package Variant</h4>
						</div>
						<!-- begin panel-body -->
			...
			<form role="form"  method="POST"  enctype="multipart/form-data">          
			  ...
			  <div class="form-group">
				...
				<input type="text" name="heading1" class="form-control" placeholder="Enter Heading 1" >
			</div>

			 <div class="form-group ">
				<label for="banner"> Enter Heading 2</label>
				<input type="text" name="heading2" class="form-control" id="" placeholder="Enter Heading 2" >
			</div>
