...
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_quality_content`");
...
if (isset($_POST['update'])) {
	...
	$query = mysqli_query($conn, "UPDATE `tbl_quality_content` SET `subheading`='$subheading',`heading1`='$heading1',`heading2`='$heading2',`content`='$content'");
	if ($query == true) {
		$_SESSION['success'] = "Updated Successfully";
		header("refresh:3;url=manage-quality-extra.php");
	} else {
...
<body>
	...
	<div id="content" class="content">
		...
		<ol class="breadcrumb pull-right">
			<li class="breadcrumb-item"><a href="javascript:;">Quality Assurance</a></li>
			<li class="breadcrumb-item active">Edit Quality Extra</li>
		</ol>
		<!-- end breadcrumb -->
		<!-- begin page-header -->
		<h1 class="page-header"><a href="javascript:;" onClick="javascript:history.go(-1)" class="btn btn-l btn-icon btn-circle btn-primary" data-click="panel-remove"><i class="fa fa-arrow-left"></i></a> Manage Quality Extra</h1>
		<!-- begin row -->
		<div class="row">
			<!-- begin col-10 -->
			<div class="col-lg-12">
				...
				<div class="panel panel-inverse">
					...
					<div class="panel-heading">
						...
						<h4 class="panel-title"> Edit Quality Extra</h4>
					</div>
					<!-- begin panel-body -->
