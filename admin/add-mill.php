...
//=============|image|============//
	...
	$query=mysqli_query($conn,"INSERT INTO `tbl_mill`(`subheading`,`subheading1`,`heading`,`content`,`image`,`sort`, `status`) VALUES ('$subheading','$subheading1','$heading','$content','$bimage','$position','$status')");
    if($query==true)
    {
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				<li class="breadcrumb-item"><a href="javascript:;"> Manage Mill</a></li>
				<li class="breadcrumb-item active">Add Mill</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Add Mill</h4>
						</div>
						<!-- begin panel-body -->
			...
			<form role="form"  method="POST"  enctype="multipart/form-data">          
              ...
              <div class="box-body">
				...
				<div class="form-group">
					...
					<input type="text" name="subheading1" class="form-control" placeholder="Enter Heading">
				</div> 				
