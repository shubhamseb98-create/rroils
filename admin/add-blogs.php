...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($conn,"INSERT INTO `tbl_blogs`(`b_image`, `b_title`,`b_url`, `b_description`, `b_status`,`b_date`, `metatag`, `metakeyword`, `metadesc`,`broad_image`,`author`) VALUES ('$bimage','$title','$prourl', '$desc','$status','$date','$metatag','$keyword','$metadesc','$brdimage','$author')");
	if($query==true)
	{
		$_SESSION['success']="Blogs Added successfully";
		...
		<div id="content" class="content">
			...
			<form role="form"  method="POST"  enctype="multipart/form-data">
			  ...
			  <div class="form-group">
                  ...
                  <input type="text" name="title" class="form-control" id="name" placeholder="Enter  Blogs Title">
                </div>

				<div class="form-group">
                    <label for="heading">Blogs URL<code>Same as Blogs name & avoid Special Characters</code></label>
                    <input type="text"  name="prourl" class="form-control" id="url" placeholder="Enter Blogs Url" required>
                </div>
                ...
                <div class="row d-none">
                   ...
                   <div class="col-md-9">
                      <div class="form-group">
                         <label for="bannerlink">Blogs Side Description</label>
				...
				<div class="form-group">
					<label for="title"> Blogs Date</label>
					<input type="date" name="date" class="form-control" id="banner" placeholder="Select  Blogs Date">
				</div>
				
				<div class="form-group">
					<label for="title"> Blogs Author</label>
					<input type="text" name="author" class="form-control" placeholder="Blogs author">
				</div>
