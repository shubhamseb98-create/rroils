...
if (isset($_POST['Deactivate']) && isset($_POST['bb'])) {
    $bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_process set status='0' where id='$act'");
	}
}
...
if (isset($_POST['Activate']) && isset($_POST['bb'])) {
    $bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_process set status='1' where id='$act'");
	}
}
...
if (isset($_POST['Delete']) && isset($_POST['bb'])) {
    $bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "delete from tbl_process where id='$act'");
	}
}

$mqry = "select * from tbl_process ";
...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;"> Process Management</a></li>
				<li class="breadcrumb-item active">Manage Process</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage Process</h4>
						</div>
						<!-- end panel-heading -->
						<form name="myform" method="post" action="">
							...
							<div class="alert alert-secondary fade show">
								...
								<div class="btn-group btn-group-justified">
									<a href="add-process.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New Process</a>
										...
										<tbody>
											...
											?>
												<tr class="odd gradeX">
													...
													<td>
														<a href="edit-process.php?bid=<?php echo $web['id']; ?>" class='label label-sm label-primary' title="Edit"><i class="fa fa-edit"></i> Edit</a>
													</td>
													<td>
														<a href="delete/process.php?bid=<?php echo $web['id']; ?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" class='label label-sm label-danger'><i class="fa fa-trash"></i> Delete</a>
													</td>
													<td width="1%">
	...
	<script>
		function updateId(id) {
			...
			xmlhttp.open("GET", "status/process.php?id=" + id, true);
			xmlhttp.send();
		}
	</script>
	<!----------------Check Box----------------------->
