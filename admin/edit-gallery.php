...
$b=$_REQUEST['cid'];
$bdata=mysqli_query($conn,"SELECT * FROM `tbl_gallery` where `glry_id`='$b'");
...
{ 
  ...
  $old = mysqli_real_escape_string($conn,$_POST['oldimg']);
    ...
    $query=mysqli_query($conn,"UPDATE `tbl_gallery` SET `glry_name`='$name',`glry_image`='$bimage',`glry_status`='$status',`glry_sort`='$position' WHERE `glry_id`='$b'");
    if($query==true)
    {
		...
		<div id="content" class="content">
			...
			<div class="row">
                ...
                <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="exampleInputPassword1" value="<?= $brec['glry_name']; ?>">
                        </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <img src="../uploads/gallery/<?= $brec['glry_image']; ?>" width="200px" height="150px">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
