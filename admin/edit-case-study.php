...
$b=$_REQUEST['bid'];
$bdata=mysqli_query($conn,"SELECT * FROM `tbl_case_study` where `b_id`='$b'");
...
//   $prourrl = str_replace(array( '\'', '"', ' ', ',' , ';', '*', ',', '/', '&', '_', '$', '--', '-', '<', '>','.' ), '-', $prourls);
  ...
  $query=mysqli_query($conn,"UPDATE `tbl_case_study` SET `b_image`='$bimage' , `b_title`='$title',`b_url`='$prourl',`b_description`='$desc',`b_status`='$status',`b_date`='$date',`metatag`='$metatag',`metakeyword`='$keyword',`metadesc`='$metadesc',`broad_image` = '$brdimage'  WHERE `b_id`='$b'");
  if($query==true)
  {
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title"> Edit Case Study</h4>
						</div>
						<!-- begin panel-body -->
			...
			<form role="form"  method="POST"  enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="bannerlink"> Case Study Title</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text"  name="prourl" class="form-control" id="url" placeholder="Enter Case Study Url" value="<?= $brec['b_url']; ?>">
                </div>
