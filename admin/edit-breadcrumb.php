...
if(isset($_POST['update']))
{
   ...
   $query=mysqli_query($conn,"UPDATE `tbl_breadcrumb` SET `brd_image`='$bimage',`brd_name`='$title',`brd_sort`='$sort',`brd_status`='$status',`metatag`='$metatag',`metakeyword`='$keyword',`metadesc`='$metadesc' WHERE `brd_id`='$b'");
   if($query==true)
      {
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="oldimg"  value="<?= $brec['brd_image']; ?>">
                   <p class="help-block">Image dimension must be 1351 X 299 & must be jpg format</p>
