...
$b = $_REQUEST['bid'];
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_youtubevideo` where `id`='$b'");
...
//   }
	...
	$query = mysqli_query($conn, "UPDATE `tbl_youtubevideo` SET `video`='$video',`sort`='$position',`status`='$status' WHERE `id`='$b'");
	if ($query == true) {
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title"> Edit Youtube Video</h4>
						</div>
						<!-- begin panel-body -->
							...
							<form role="form" method="POST" enctype="multipart/form-data">
								<div class="box-body">
	                                ...
	                                <div class="form-group">
										...
										<input type="text" name="video" class="form-control" placeholder="Enter Youtube Video ID" value="<?= $brec['video']; ?>">
									</div>
