				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage Case Study</h4>
						</div>
						<!-- end panel-heading -->
                     <form name="myform" method="post" action=""> 
						...
						<div class="alert alert-secondary fade show">
                          ...
                          <a href="add-case-study.php" class="btn btn-default active"><i class="fa fa-plus"></i>Add New Case Study</a>
						...
						<div class="panel-body">
                         <div class="table-responsive">
							<table id="data-table-responsive" class="table table-striped table-bordered">
								...
								<tbody>
                                <?php
								     $mqry="select * from tbl_case_study order by b_date desc"; 
								     $count=1; 
			                    ...
			                    ?>
									<tr class="odd gradeX">
										...
										<td>
                                          <a href="edit-case-study.php?bid=<?php echo $web['b_id'];?>" class='label label-sm label-primary' data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                        </td>
										<td>
                                          <a href="delete/case-study.php?bid=<?php echo $web['b_id'];?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" data-toggle="tooltip" title="Delete" class='label label-sm label-danger'><i class="fa fa-trash"></i> Delete</a>
                                         </td>
