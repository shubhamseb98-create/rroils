...
//=============|image|============//
	...
	$query=mysqli_query($conn,"INSERT INTO `tbl_core_values`(`name`,`sort`, `status`) VALUES ('$name','$position','$status')");
    if($query==true)
    {
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Add Core Value</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Add Core Value</h4>
						</div>
						<!-- begin panel-body -->
