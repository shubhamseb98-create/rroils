...
//   $prourrl = str_replace(array( '\'', '"', ' ', ',' , ';', '*', ',', '/', '&', '_', '$', '--', '-', '<', '>','.' ), '-', $prourls);
  ...
  $old = mysqli_real_escape_string($conn,$_POST['oldimg']); 
    $oldbrd = mysqli_real_escape_string($conn,$_POST['oldimgbrd']); 
  ...
  $query=mysqli_query($conn,"UPDATE `tbl_blogs` SET `b_image`='$bimage' , `b_title`='$title',`b_url`='$prourl',`b_description`='$desc',`b_status`='$status',`b_date`='$date',`metatag`='$metatag',`metakeyword`='$keyword',`metadesc`='$metadesc',`broad_image` = '$brdimage',`b_alt` = '$alt',`author` = '$author'  WHERE `b_id`='$b'");
  if($query==true)
  {
			...
			<form role="form"  method="POST"  enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  name="prourl" class="form-control" id="url" placeholder="Enter Blogs Url" value="<?= $brec['b_url']; ?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="oldimg"  value="<?= $brec['b_image']; ?>">
                   <p class="help-block">Image dimension must be 734 × 400 px & must be jpg format</p>
                   <img src="../uploads/blogs/<?= $brec['b_image']; ?>" style="width:20%;">
                </div>
                
                <div class="form-group">
                  <label for="bannerlink">File Alt</label>
                ...
                <div class="form-group">
					...
					<input type="hidden" name="oldimgbrd"  value="<?= $brec['broad_image']; ?>">
					<p class="help-block">Image dimension must be 1432 × 320 px & must be jpg format</p>
                ...
                <div class="form-group">
                  ...
                  <textarea  name="desc"  placeholder="Enter  Description" class="form-control" id="editor3"><?=$brec['b_description']?></textarea>
                </div>
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="author" class="form-control" value="<?= $brec['author']; ?>">
                  </div>
