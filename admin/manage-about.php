...
if (isset($_POST['update'])) {
	...
	$query = mysqli_query($conn, "UPDATE `tbl_about` SET `image`='$image',`subheading`='$subheading',`heading`='$heading',`subheading1`='$subheading1',`content`='$content'");
	if ($query == true) {
					...
					<div class="panel-body">
						<form role="form" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="form-group col-md-6">
									<label for="banner">Enter Subheading 1</label>
									<input type="text" name="subheading1" class="form-control" value="<?= $brec['subheading1']; ?>">
								</div>
							</div>	
