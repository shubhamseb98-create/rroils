...
if (isset($_POST['update'])) {
	...
	$query = mysqli_query($conn, "UPDATE `tbl_acheivements` SET `number`='$number',`name`='$name',`unit`='$unit',`operator`='$operator',`sort`='$position',`status`='$status' WHERE `id`='$b'");
	if ($query == true) {
							...
							<form role="form" method="POST" enctype="multipart/form-data">
								<div class="box-body">
                                	...
                                	<div class="form-group">
										<label for="banner" > Enter Number</label>
										<input name="number" class="form-control" id="" placeholder="Enter Achievement Number" value="<?= $brec['number']; ?>">
									</div>
	                              
                                	<div class="form-group">
										<label for="banner" > Enter Name</label>
										<input name="name" class="form-control" id="" placeholder="Enter Achievement Name" value="<?= $brec['name']; ?>">
									</div>
	                              
                                	<div class="form-group">
										<label for="banner" > Enter Unit</label>
										<input name="unit" class="form-control" id="" placeholder="Enter Achievement Unit" value="<?= $brec['unit']; ?>">
									</div>
	                              
                                	<div class="form-group">
										<label for="banner" > Enter Operator</label>
										<input name="operator" class="form-control" id="" placeholder="Enter Achievement Operator" value="<?= $brec['operator']; ?>">
									</div>
