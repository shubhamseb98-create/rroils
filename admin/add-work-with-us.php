...
//=============|image|============//
	...
	if($bimages!="")
	{
		...
		move_uploaded_file($_FILES["ach_image"]["tmp_name"], "../uploads/work_with_us/".$bimage); 
	}
	else
	{
		$bimage="";	
	...
	$query=mysqli_query($conn,"INSERT INTO `tbl_workwithus`(`title`,`content`,`icon`,`sort`, `status`) VALUES ('$title','$content','$bimage','$position','$status')");
    if($query==true)
    {
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Add Work With Us</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Add Work With Us</h4>
						</div>
						<!-- begin panel-body -->
