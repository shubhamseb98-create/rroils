...
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_labeltext`");
...
if (isset($_POST['update'])) {
	...
	$query = mysqli_query($conn, "UPDATE `tbl_labeltext` SET `subheading`='$subheading',`heading1`='$heading1',`heading2`='$heading2' WHERE `id`='$brec[id]'");
	if ($query == true) {
		$_SESSION['success'] = "Updated Successfully";
		header("refresh:3;url=manage-label-extra.php");
	} else {
...
<body>
	...
	<div id="content" class="content">
		...
		<ol class="breadcrumb pull-right">
			<li class="breadcrumb-item"><a href="javascript:;">Label Text Management</a></li>
			<li class="breadcrumb-item active">Edit Label Text</li>
		</ol>
		<!-- end breadcrumb -->
		<!-- begin page-header -->
		<h1 class="page-header"><a href="javascript:;" onClick="javascript:history.go(-1)" class="btn btn-l btn-icon btn-circle btn-primary" data-click="panel-remove"><i class="fa fa-arrow-left"></i></a> Manage Label Text</h1>
		<!-- begin row -->
		<div class="row">
			<!-- begin col-10 -->
			<div class="col-lg-12">
				...
				<div class="panel panel-inverse">
					...
					<div class="panel-heading">
						...
						<h4 class="panel-title"> Edit Label Text</h4>
					</div>
					<!-- begin panel-body -->
