...
$bdata2=mysqli_query($conn,"SELECT * FROM `tbl_service_category` WHERE `status`='1' and `id`='$brec[category_id]'");
...
if(isset($_POST['update']))
{
  ...
  $alt = mysqli_real_escape_string($conn,$_POST['alt']); 
    ...
    if($broadimage!='')
    {
      ...
      $query=mysqli_query($conn,"UPDATE `tbl_service` SET `category_id`='$category',`name`='$name',`heading`='$heading',`url`='$prourl',`tag`='$metatag',`keyword`='$keyword',`metadesc`='$metadesc',`broadimage`='$broadimage',`alt`='$alt',`sort`='$position',`image`='$bimage',`long_desc`='$long_desc',`short_desc`='$short_desc',`status`='$status',`list_desc`='$list_desc',`m_price`='$m_price',`s_price`='$s_price' WHERE `id`='$b'");
               ...
               <div class="row">
                ...
                <div class="col-lg-6">
                 <div class="form-group">
                    ...
                    <input type="text" name="url" class="form-control" value="<?= $brec['url']; ?>" id="url" placeholder="Enter Product Url" required>
                </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text"  name="s_price" class="form-control" id="heading" value="<?= $brec['s_price']; ?>">
                </div>
                </div>
                <div class="col-lg-4">
                <div class="form-group">
                  <label for="heading">Max Price</label>
                  <input type="text"  name="m_price" class="form-control" id="heading" value="<?= $brec['m_price']; ?>">
                </div>
                </div>
                ...
                <div class="col-lg-12">
                 <div class="form-group">
                  ...
                  <textarea  name="list_desc" class="form-control" id="editor3" placeholder="Enter text ..." rows="6"><?= $brec['list_desc']; ?></textarea>
                </div>
                </div>                
