...
<body>
										...
										<tbody>
											...
											?>
												<tr class="odd gradeX">
													...
													<td width="1%" class="with-img"><?php if ($web['bnr_image'] == '') { ?><img src="../images/no.png" class="img-rounded height-80" /><?php } else { ?><img src="../uploads/banner/<?php echo $web['bnr_image']; ?>" class="img-rounded height-80" /><?php } ?></td>
													<td width="30%"style="font-weight:700; color:#000;"><?= $web['bnr_title']; ?></td>
													<td><?= ($web['bnr_type'] == 'video') ? 'Video' : 'Image'; ?></td>
													<td>
														<div class="switcher">
													...
													<td><a href="edit-banner.php?bid=<?php echo $web['bnr_id']; ?>" class='label label-sm label-primary' data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i> Edit</a></td>
													<td><a href="delete/banner.php?bid=<?php echo $web['bnr_id']; ?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" data-toggle="tooltip" title="Delete" class='label label-sm label-danger'><i class="fa fa-trash"></i> Delete</a></td>
													<td width="1%"><input type="checkbox" class="checkbox" value="<?php echo $web['bnr_id']; ?>" name="bb[]" id="bb[]"></td>
												</tr>
											<?php $count++;
											} ?>
										</tbody>
	...
	<script>
		...
		function updateIdd(id) {
			...
			xmlhttp.open("GET", "status/bannervideo.php?id=" + id, true);
			xmlhttp.send();
		}
	</script>
