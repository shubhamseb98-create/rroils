...
//=============|image|============//
	...
	$query=mysqli_query($conn,"INSERT INTO `tbl_choose`(`name`,`sort`, `status`) VALUES ('$name','$position','$status')");
    if($query==true)
    {
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Add Choose</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Add Choose</h4>
						</div>
						<!-- begin panel-body -->
