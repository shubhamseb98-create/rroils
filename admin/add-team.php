...
<body>
	...
	<?php require("includes/left.php"); ?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header"><a href="javascript:;" onClick="javascript:history.go(-1)" class="btn btn-l btn-icon btn-circle btn-primary" data-click="panel-remove"><i class="fa fa-arrow-left"></i></a> Add Team</h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
             ...
             <div class="row">
				  ...
				  <div class="col-sm-12">
						<div class="form-group">
							...
							<input type="text"  name="location"  placeholder="Enter Designation"  class="form-control" id="bannerlink">
						</div>
				  </div>
			  </div>
                ...
                <div class="form-group d-none">
                  <label>Short Description</label>
                	<textarea name="short_description" id="editor2" placeholder="Enter Short Description" class="form-control" rows="3"></textarea>
                </div>
                <div class="row">
				  ...
				  <div class="col-sm-12 d-none">
						<div class="form-group">
							<label for="heading">Heading</label>
							<input type="text"  name="subheading" class="form-control" placeholder="Enter Heading">
						</div>
					  </div>
				  <div class="col-sm-12">
        			    <div class="form-group">
                  ...
                  <div class="row d-none">
                      <div class="col-sm-4">
					 	 <div class="form-group">
							...
							<input type="text"  name="whatsapp"   class="form-control" id="bannerlink" placeholder="Enter Phone No.">
						</div>
					  </div>
					  <div class="col-sm-4">
					 	 <div class="form-group">
							<label for="bannerlink">Gmail ID</label>
							<input type="text"  name="gmail"   class="form-control" id="bannerlink" placeholder="Enter Gmail ID">
						</div>
					  </div>
					  <div class="col-sm-4">
						<div class="form-group">
					  ...
					  <div class="col-sm-4">
					 	 <div class="form-group">
							...
							<input type="text"  name="insta"   class="form-control" id="bannerlink" placeholder="Enter Instagram Link">
						</div>
					  </div>
					   <div class="col-sm-4">
					 	 <div class="form-group">
							<label for="bannerlink">Pinterest</label>
							<input type="text"  name="google"  class="form-control" id="bannerlink" placeholder="Enter Pinterest Link">
						</div>
					  </div>
				  </div>
                <div class="row">
