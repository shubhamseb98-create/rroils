...
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_home_about` WHERE `id` = '2'");
...
if (isset($_POST['update'])) {
	...
	if ($image1 != "") {
		...
		@unlink("../uploads/choose/" . $oldimage1);
		move_uploaded_file($_FILES["image1"]["tmp_name"], "../uploads/choose/" . $image1);
	} else {
		$image1 = $brec['image'];
	} 


	$query = mysqli_query($conn, "UPDATE `tbl_home_about` SET `image`='$image1',`subheading`='$subheading',`content`='$content',`heading`='$heading' WHERE `id` = '2'"); 
	if ($query == true) {
							...
							<div class="row">
                                ...
                                <div class="col-6">
									<div class="form-group">
										...
										<img src="../uploads/choose/<?= $brec['image']; ?>" style="width:30%; height:100px" class="bg-dark">
									</div>
								</div>
