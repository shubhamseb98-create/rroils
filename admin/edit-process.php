...
$b = $_REQUEST['bid'];
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_process` where `id`='$b'");
...
if (isset($_POST['update'])) {
  ...
  if($ach_image!='')
  {
	...
	$query = mysqli_query($conn, "UPDATE `tbl_process` SET `title`='$title',`content`='$content',`icon`='$ach_images',`sort`='$position',`status`='$status' WHERE `id`='$b'");
	if ($query == true) {
