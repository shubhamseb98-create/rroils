...
$sqqll ="SELECT `pro_id`, `pro_logo`, `pro_second_logo`,`pro_dark_logo`, `pro_favicon` , `pro_title`, `pro_keyword`, `pro_detail` FROM `tbl_profile`";
...
if(isset($_POST['logosecondsubmit'])){
	$tmpName = $_FILES['second_logo']['tmp_name'];
    if(file_exists($tmpName)){
		$fileName = $_FILES['second_logo']['name'];	
		$ext = pathinfo($fileName, PATHINFO_EXTENSION);
		$fileName = 'secondlogo.'.$ext;
        if(move_uploaded_file($tmpName, '../uploads/'.$fileName)==true){

			mysqli_query($conn, "UPDATE tbl_profile SET pro_second_logo = '$fileName' WHERE pro_id = 1 ");
			$_SESSION['success']="Second Logo successfully updated";	
			header("refresh: 1;");
		}else{
			$_SESSION['error']="Something  wrong";	
		}
...
if(isset($_POST['submitseo'])){
	...
	$actionQ="UPDATE tbl_profile SET pro_title='$meta_title',pro_keyword= '$meta_keyword',pro_detail='$meta_description' WHERE pro_id=1";
...
if(isset($_POST['subcontact'])){
  ...
  $office_hours=mysqli_real_escape_string($conn,$_POST['office_hours']);
	...
	$actionQ="UPDATE tbl_contact SET con_phone1 = '$phone1', con_phone2='$phone2', con_email1='$email1', con_email2='$email2', con_address='$address', con_map='$map', con_detail = '$details', con_office_hours = '$office_hours' WHERE con_id =1";
    $action=mysqli_multi_query($conn,$actionQ);
     if($action==true){
                              ...
                              <div class="box-body">
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <textarea class="form-control" name="office_hours"><?php echo $root['con_office_hours'];?></textarea>
                                </div>
                                ...
                                <!--     begin panel -->
                                    <div class="panel panel-inverse">
                                        ...
                                        <div class="panel-heading">
                                            ...
                                            <h4 class="panel-title">Website Second Logo</h4>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            <form role="form"  method="POST"  enctype="multipart/form-data">
                                                <div class="box-body">
                                                  <div class="form-group ">
                                                   <p><img src="<?= SITE_URL ?>uploads/<?php echo $rowww['pro_second_logo'];?>" height="80"></p>
                                                    <input type="file" name="second_logo" class="form-control">                                  
                                                  </div>
                                                </div>
                                               
                                               <div class="box-footer">
                                                  <button type="submit" name="logosecondsubmit" onClick="if(confirm('Are You Sure Want To Change This Second Logo')){ return true;} else { return false; }" class="btn btn-primary">Submit</button>
                                               </div>
                                         </form>
                                        </div>
                                    </div>
