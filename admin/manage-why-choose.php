...
$bdata = mysqli_query($conn, "SELECT * FROM `tbl_howwork` WHERE `id` = '1'");
...
if (isset($_POST['update'])) {
	...
	if ($image1 != "") {
		...
		@unlink("../uploads/works/" . $brec['image']);
	...
	if ($icon2 != "") {
		$icon2 = time() . "_" . $icon2;
		@unlink("../uploads/works/" . $brec['icon2']);
		move_uploaded_file($_FILES["icon2"]["tmp_name"], "../uploads/works/" . $icon2);
	} else {
		$icon2 = $brec['icon2'];
	} 
	...
	if ($icon1 != "") {
		$icon1 = time() . "_" . $icon1;
		@unlink("../uploads/works/" . $brec['icon1']);
		move_uploaded_file($_FILES["icon1"]["tmp_name"], "../uploads/works/" . $icon1);
	} else {
		$icon1 = $brec['icon1'];
	} 
	...
	if ($icon3 != "") {
		$icon3 = time() . "_" . $icon3;
		@unlink("../uploads/works/" . $brec['icon3']);
		move_uploaded_file($_FILES["icon3"]["tmp_name"], "../uploads/works/" . $icon3);
	} else {
		$icon3 = $brec['icon3'];
	} 	

	$query = mysqli_query($conn, "UPDATE `tbl_howwork` SET `heading1`='$heading1',`heading2`='$heading2',`content`='$content',`i_heading1`='$i_heading1',`i_text1`='$i_text1',`i_heading2`='$i_heading2',`i_text2`='$i_text2',`i_heading3`='$i_heading3',`i_text3`='$i_text3',`image`='$image1',`icon1`='$icon1',`icon2`='$icon2',`icon3`='$icon3'"); 
	if ($query == true) {
...
<body>
	...
	<div id="content" class="content">
		...
		<ol class="breadcrumb pull-right">
			<li class="breadcrumb-item"><a href="javascript:;">Work with Us Management</a></li>
			<li class="breadcrumb-item active">Edit Work with Us</li>
		</ol>
		<!-- end breadcrumb -->
		<!-- begin page-header -->
		<h1 class="page-header"><a href="javascript:;" onClick="javascript:history.go(-1)" class="btn btn-l btn-icon btn-circle btn-primary" data-click="panel-remove"><i class="fa fa-arrow-left"></i></a> Manage Work with Us</h1>
		<!-- begin row -->
		<div class="row">
			<!-- begin col-10 -->
			<div class="col-lg-12">
				...
				<div class="panel panel-inverse">
					...
					<div class="panel-heading">
						...
						<h4 class="panel-title">Edit Work with Us</h4>
					</div>
					<!-- begin panel-body -->
							...
							<div class="box-body">
                                ...
                                <div class="col-6">
									<div class="form-group">
										...
										<img src="../uploads/works/<?= $brec['image']; ?>" style="width:30%; height:100px" class="bg-dark">
									</div>
								</div>								
								...
								<div class="row">
										...
										<div class="form-group col-6">
											<label for="banner">Work Heading 1</label>
										...
										<div class="col-6">
											<div class="form-group">
												...
												<p class="help-block">Image dimension must be 395 × 436 px & must be jpg format</p>
												<img src="../uploads/works/<?= $brec['icon1']; ?>" style="width:30%; height:100px" class="bg-dark">
											</div>
										</div>									
										
										<div class="form-group col-12">  
											<label for="banner">Enter Work Text 1</label>
								...
								<div class="row">
										...
										<div class="form-group col-6">
											<label for="banner">Work Heading 2</label>
										...
										<div class="col-6">
											<div class="form-group">
												...
												<p class="help-block">Image dimension must be 395 × 436 px & must be jpg format</p>
												<img src="../uploads/works/<?= $brec['icon2']; ?>" style="width:30%; height:100px" class="bg-dark">
											</div>
										</div>									
										
										<div class="form-group col-12">  
											<label for="banner">Enter Work Text 2</label>
								...
								<div class="row">
										...
										<div class="form-group col-6">
											<label for="banner">Work Heading 3</label>
										...
										<div class="col-6">
											<div class="form-group">
												...
												<p class="help-block">Image dimension must be 395 × 436 px & must be jpg format</p>
												<img src="../uploads/works/<?= $brec['icon3']; ?>" style="width:30%; height:100px" class="bg-dark">
											</div>
										</div>									
										
										<div class="form-group col-12">  
											<label for="banner">Enter Work Text 3</label>
